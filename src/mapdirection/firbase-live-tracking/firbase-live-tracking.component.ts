...
@Component({
  selector: 'app-firbase-live-tracking',
  templateUrl: './firbase-live-tracking.component.html',
  styleUrls: ['./firbase-live-tracking.component.scss'],
})
export class FirbaseLiveTrackingComponent  implements OnInit {
