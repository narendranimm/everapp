...
@Component({
  selector: 'app-g-places-api',
  templateUrl: './g-places-api.component.html',
  styleUrls: ['./g-places-api.component.scss'],
})
export class GPlacesApiComponent  implements OnInit ,OnDestroy{
  places: any[] = [];
  query!: string;
