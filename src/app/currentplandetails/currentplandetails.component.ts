...
@Component({
  selector: 'app-currentplandetails',
  templateUrl: './currentplandetails.component.html',
  styleUrls: ['./currentplandetails.component.scss'],
})
export class CurrentplandetailsComponent  implements OnInit {
