...
@Component({
  selector: 'app-everhomepage',
  templateUrl: './everhomepage.component.html',
  styleUrls: ['./everhomepage.component.scss'],
})
export class EverhomepageComponent  implements OnInit {
  slides:any=[]
  lati: any = '';  
  longi: any = '';  
  bikeHub:any;
